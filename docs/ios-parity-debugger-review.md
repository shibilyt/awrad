...
| 6 — Wird lifecycle | **Pass** | Canonical eight-part content, deterministic IDs, migration, cadence, continuous scroll progress, exact resume, repeat gating, streak, and custom lifecycle pass native tests; light, dark, and Arabic RTL reader smoke passes on iOS 18.4. |
