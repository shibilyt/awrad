...
Standard patterns used across the Awrad API codebase. All new code should follow these patterns unless there is a documented reason to deviate.

## Architecture Overview

```
lib/
  awrad_api/              → Business logic contexts (Accounts, future: Dhikr, Goals, etc.)
  awrad_api_web/          → Web layer (router, controllers, LiveViews, plugs, components)
