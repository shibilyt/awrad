defmodule AwradApiWeb.Api.ProgressSyncControllerTest do
  ...
  test "kill switch makes transfer pages retryable", %{conn: conn} do
    ...
    previous = Application.get_env(:awrad_api, :progress_sync_enabled, true)
    Application.put_env(:awrad_api, :progress_sync_enabled, false)
    on_exit(fn -> Application.put_env(:awrad_api, :progress_sync_enabled, previous) end)
