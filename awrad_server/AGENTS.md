...
These instructions apply inside `awrad_server/` and extend the repository-wide rules in [`../AGENTS.md`](../AGENTS.md). This is the Phoenix web application and JSON API for the umbrella repository.
