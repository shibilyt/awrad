...
config :awrad_server, :progress_sync_maintenance_enabled, false
config :awrad_server, :built_in_registry_guard_enabled, false
...
config :awrad_server, AwradServer.Accounts.AuthRateLimiter,
  pepper: "test-only-rate-limit-pepper-32-characters!"

# In test we don't send emails
config :awrad_server, AwradServer.Mailer, adapter: Swoosh.Adapters.Test
