defmodule AwradServer.Tracking.ProgressModelV1Test do
  use ExUnit.Case, async: true

  alias AwradServer.Dhikr.BuiltInRegistry
  alias AwradServer.Tracking.{CountEntry, Goal, GoalReminder, GoalSlot}
