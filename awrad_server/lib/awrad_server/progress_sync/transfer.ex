defmodule AwradServer.ProgressSync.Transfer do
  @moduledoc false
  ...
  defp cursor_position("delta", cursor, user_id) when is_binary(cursor) do
    case Phoenix.Token.verify(AwradServerWeb.Endpoint, @cursor_salt, cursor,
  ...
  defp encode_cursor(user_id, generation, revision) do
    Phoenix.Token.sign(AwradServerWeb.Endpoint, @cursor_salt, %{
      "user_id" => user_id,
