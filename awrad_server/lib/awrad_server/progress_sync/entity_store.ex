defmodule AwradServer.ProgressSync.EntityStore do
  @moduledoc false

  import Ecto.Query

  alias AwradServer.ProgressSync.{Document, EntityConflict, EntityRecord, Materializer}
  ...
  defp assignable_dhikr?(user_id, dhikr_id) do
    Repo.exists?(
      from d in AwradServer.Dhikr.Dhikr,
        where:
