defmodule AwradServer.Accounts.Token do
  use Joken.Config
  ...
  defp retry_secrets do
    base = Application.fetch_env!(:awrad_server, __MODULE__)[:refresh_retry_secret]
    {:crypto.hash(:sha256, base <> ":encrypt"), :crypto.hash(:sha256, base <> ":sign")}
  end

  defp signing_secret, do: Application.fetch_env!(:awrad_server, __MODULE__)[:signing_secret]
