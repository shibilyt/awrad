defmodule AwradServer.Dhikr.Dhikr do
  use Ecto.Schema
  ...
  schema "dhikrs" do
    ...
    has_many :translations, AwradServer.Dhikr.DhikrTranslation
    many_to_many :categories, AwradServer.Dhikr.Category, join_through: "dhikr_categories"
