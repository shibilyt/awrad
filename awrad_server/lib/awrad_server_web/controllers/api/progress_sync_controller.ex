defmodule AwradServerWeb.Api.ProgressSyncController do
  use AwradServerWeb, :controller

  alias AwradServer.ProgressSync
  alias AwradServer.ProgressSync.Transfer
  ...
  defp enabled do
    if Application.get_env(:awrad_server, :progress_sync_enabled, true),
      do: :ok,
