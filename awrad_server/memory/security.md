...
This page records the security invariants and review practices that should guide new Awrad Server work. Executable code, migrations, configuration, and tests remain authoritative. Update this page when a security boundary or accepted control changes.
...
controllers use `AwradServerWeb.BrowserAuthProtection`, which applies the existing
