...
class GoalProgressUseCaseTest {
    ...
    fun `per due date progress uses only the effective date count`() {
        val goal = goal(id = 7, targetPolicy = TargetPolicy.PER_DUE_DATE, target = 100)
        val entries = listOf(
            entry(goalId = 7, count = 40, date = "2026-05-24"),
            entry(goalId = 7, count = 15, date = "2026-05-23"),
            entry(goalId = 8, count = 99, date = "2026-05-24"),
        )
    ...
    fun `cumulative progress uses all positive entries for the goal`() {
        val goal = goal(id = 7, targetPolicy = TargetPolicy.CUMULATIVE_TOTAL, target = 100)
        val entries = listOf(
            entry(goalId = 7, count = 40, date = "2026-05-24"),
            entry(goalId = 7, count = 15, date = "2026-05-23"),
            entry(goalId = 8, count = 99, date = "2026-05-24"),
    ...
    fun `period progress includes only entries inside current window`() {
        ...
        val entries = listOf(
            entry(goalId = 7, count = 10, date = "2026-05-24"),
            entry(goalId = 7, count = 25, date = "2026-05-25"),
            entry(goalId = 7, count = 30, date = "2026-05-31"),
            entry(goalId = 7, count = 45, date = "2026-06-01"),
        )
    ...
    fun `period progress ignores malformed legacy history dates`() {
        ...
        val entries = listOf(
            entry(goalId = 7, count = 25, date = "2026-05-25"),
            entry(goalId = 7, count = 99, date = "not-a-date"),
        )
    ...
    fun `tracker summary reports completion after any count`() {
        val goal = goal(id = 7, targetPolicy = TargetPolicy.NONE, target = null)
        val entries = listOf(entry(goalId = 7, count = 1, date = "2026-05-24"))
    ...
    private fun entry(goalId: Long, count: Long, date: String): CountEntry =
        CountEntry(goalId = goalId, slotId = null, count = count, date = date, lastUpdated = 0)
}
