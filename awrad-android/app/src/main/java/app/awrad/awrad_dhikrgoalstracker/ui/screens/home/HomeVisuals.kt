...
private fun lightThemeVisuals(
    ...
    isNight = isNight,
    isDarkTheme = false,
    featuredImageRes = R.drawable.home_continue_minimal_light,
    goalsImageRes = R.drawable.home_goals_minimal_light,
    celestial = celestial,
...
private fun darkThemeVisuals(
    ...
    isNight = isNight,
    isDarkTheme = true,
    featuredImageRes = R.drawable.home_continue_minimal_dark,
    goalsImageRes = R.drawable.home_goals_minimal_dark,
    celestial = celestial,
    screenGradient = listOf(
        Color(0xFF010707),
        Color(0xFF061814),
