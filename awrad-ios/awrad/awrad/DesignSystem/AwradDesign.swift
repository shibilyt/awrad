...
enum AwradTheme {
    ...
    static let flameAmber = dynamicColor(light: 0xD4A843, dark: 0xE8C878)
    static let flameOrange = dynamicColor(light: 0xD97941, dark: 0xE99A6A)
    static let flameRed = dynamicColor(light: 0xC94A4A, dark: 0xF08A8A)
